            ...
            <b-row>
                <b-col cols="4" class="mt-5">
                    ...
                    >
                        ...
                        <b-card-body>
                        <b-card-title>{{this.$store.state.current_product.name.charAt(0).toUpperCase() + this.$store.state.current_product.name.slice(1)}}</b-card-title>
                        <b-card-text>
                            {{this.$store.state.current_product.description.charAt(0).toUpperCase() + this.$store.state.current_product.description.slice(1)}}
                        </b-card-text>
                        </b-card-body>

                        <b-list-group flush>
                            <b-list-group-item><b>Marca:</b> {{this.$store.state.current_product.brand}}</b-list-group-item>
                            <b-list-group-item><b>Precio:</b> {{this.$store.state.current_product.price}}</b-list-group-item>
                            <b-list-group-item> <b>Fecha de creación:</b> {{this.$store.state.current_product.created_at.substring(0,10)}}</b-list-group-item>
                            <b-list-group-item> 
                                <b-form-rating size="sm" disabled :value= "this.$store.state.current_product.score"></b-form-rating>
                            </b-list-group-item>
                        </b-list-group>
                ...
                <b-col cols="8">
                    ...
                    >
                        <b-row no-gutters>
                            <b-col md="6">
                                <b-card-body :title="review.comment">
                                </b-card-body>
                            </b-col>
                        </b-row>
                    </b-card>
